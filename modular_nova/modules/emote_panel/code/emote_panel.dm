...
GAME_VERB_PROC(/mob/living, emote_yip, "> Yip", "Emotes+")
	src.emote("yip", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_gecker, "> Gecker", "Emotes+")
	src.emote("gecker", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_fwhine, "> Fox Whine", "Emotes+")
...
GAME_VERB_PROC(/mob/living, emote_bubble, "> Bubble", "Emotes+")
	src.emote("bubble", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_pop, "> Pop", "Emotes+")
...
GAME_VERB_PROC(/mob/living, emote_mrrp, "> Mrrp", "Emotes+")
	src.emote("mrrp", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_prbt, "> Prbt", "Emotes+")
	src.emote("prbt", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_awuff, "> Ah Woof", "Emotes+")
	src.emote("awuff", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_arf, "> Arf", "Emotes+")
	src.emote("arf", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_coyhowl, "> Coyote Howl", "Emotes+")
	src.emote("coyhowl", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_wolfhowl, "> Wolf Howl", "Emotes+")
	src.emote("wolfhowl", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_dwhine, "> Dog Whine", "Emotes+")
	src.emote("dwhine", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_dgrowl, "> Dog Growl", "Emotes+")
	src.emote("dgrowl", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_aggrobark, "> Aggressive Bark", "Emotes+")
	src.emote("aggrobark", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_dcomplain, "> Dog Complain", "Emotes+")
	src.emote("dcomplain", intentional = TRUE)

GAME_VERB_PROC(/mob/living, emote_meowdeep, "> Meow Deeply", "Emotes+")
