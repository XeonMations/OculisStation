...
ADMIN_VERB(cmd_assume_direct_control, R_ADMIN|R_DEBUG, "Assume Direct Control", "Assume direct control of a mob.", ADMIN_CATEGORY_DEBUG) // OCULIS EDIT, ORIGINAL: ADMIN_VERB(cmd_assume_direct_control, R_ADMIN, "Assume Direct Control", "Assume direct control of a mob.", ADMIN_CATEGORY_DEBUG)
	VERB_ARG_TYPED(M, VERB_ARG_TYPE_MOB, VERB_ARG_SOURCE_WORLD, /mob)
	if(M.ckey)
...
ADMIN_VERB(cmd_give_direct_control, R_ADMIN|R_DEBUG, "Give Direct Control", "Give direct control of a mob to another player.", ADMIN_CATEGORY_GAME) // OCULIS EDIT, ORIGINAL: ADMIN_VERB(cmd_give_direct_control, R_ADMIN, "Give Direct Control", "Give direct control of a mob to another player.", ADMIN_CATEGORY_GAME)
	VERB_ARG_TYPED(M, VERB_ARG_TYPE_MOB, VERB_ARG_SOURCE_WORLD, /mob)
	if(!M)
		return
	if(M.ckey)
