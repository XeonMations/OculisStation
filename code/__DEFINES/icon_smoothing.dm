...
#define SMOOTH_GROUP_CRYSTAL_WALL S_OBJ(94) ///turf/closed/wall/mineral/violetspace_crystal
#define SMOOTH_GROUP_SILK_WALLS S_OBJ(95) ///turf/closed/wall/material/silk /obj/structure/falsewall/silk
//OCULIS EDIT END
