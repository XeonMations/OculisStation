...
#define BLOOD_TYPE_DIONA "CH" // IRIS EDIT ADDITION
...
#define AGE_CHRONO_MAX 1000 // IRIS EDIT - Increased from 400 to 1000
#define AGE_MINOR 18 //legal age of space drinking and smoking //IRIS EDIT
