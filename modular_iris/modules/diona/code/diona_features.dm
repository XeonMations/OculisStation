/datum/preference/choiced/diona_leaves
	savefile_key = "feature_diona_leaves"
...
/datum/preference/choiced/diona_leaves/init_possible_values()
	...
	for (var/body_part in body_parts)
		diona_body.blend_icon(uni_icon('modular_iris/modules/diona/icons/bodyparts.dmi', "diona_[body_part]", dir = SOUTH), ICON_OVERLAY)

	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_LEAVES])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_LEAVES][markings_name]
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_leaves_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_thorns
	savefile_key = "feature_diona_thorns"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_thorns/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_THORNS])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_THORNS][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_thorns_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_flowers
	savefile_key = "feature_diona_flowers"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_flowers/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_THORNS])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_FLOWERS][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_flowers_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_moss
	savefile_key = "feature_diona_moss"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_moss/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_MOSS])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_MOSS][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_moss_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_mushroom
	savefile_key = "feature_diona_mushroom"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_mushroom/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_MUSHROOM])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_MUSHROOM][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_mushroom_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_antennae
	savefile_key = "feature_diona_antennae"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_antennae/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_ANTENNAE])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_ANTENNAE][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_antennae_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_eyes
	savefile_key = "feature_diona_eyes"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_eyes/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_EYES])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_EYES][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_eyes_ADJ"), ICON_OVERLAY)
...
/datum/preference/choiced/diona_pbody
	savefile_key = "feature_diona_pbody"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
...
/datum/preference/choiced/diona_pbody/init_possible_values()
	...
	for (var/markings_name in SSaccessories.feature_list[FEATURE_DIONA_PBODY])
		var/datum/sprite_accessory/markings = SSaccessories.feature_list[FEATURE_DIONA_PBODY][markings_name]
		var/datum/universal_icon/icon_with_markings = diona_body.copy()
		...
		icon_with_markings.blend_icon(uni_icon('modular_iris/modules/diona/icons/diona_markings.dmi', "m_diona_pbody_ADJ"), ICON_OVERLAY)
